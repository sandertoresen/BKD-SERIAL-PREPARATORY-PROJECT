BKD_TREE_SRC=includes/BKD_Tree.cpp
KDB_TREE_SRC=includes/KDB_Tree.cpp
TESTS_SRC=includes/tests.cpp
MAIN_SRC= main.cpp

PROGRAM_SRC=$(MAIN_SRC) $(BKD_TREE_SRC) $(TESTS_SRC) $(KDB_TREE_SRC)

HEADERS=includes/BKD_Tree.h includes/Config.h includes/tests.h includes/KDB_Tree.h
...
program32s: $(PROGRAM_SRC) $(HEADERS) Makefile
	g++ $(PROGRAM_SRC) -g -o $@ 
